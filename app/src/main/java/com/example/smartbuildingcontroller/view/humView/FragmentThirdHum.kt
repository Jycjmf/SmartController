package com.example.smartbuildingcontroller.view.humView
...
import com.example.smartbuildingcontroller.databinding.FragmentFirHumBinding
...
class FragmentThirdHum : Fragment() {
    private val model: ConnectToServerViewModel by activityViewModels()
    lateinit var binding:FragmentFirHumBinding
    ...
    override fun onCreateView(
        ...
        binding= FragmentFirHumBinding.inflate(inflater,container,false)
        ...
        val aaChartModel = AAChartModel()
            ...
            .series(
                arrayOf(
                    AASeriesElement()
                        .name("湿度")
                        .data(model.notifyHandler.listCan.humListCan.firHum.value!!.toArray())
                )
            )
        model.notifyHandler.listCan.humListCan.firHum.observe(requireActivity(), Observer {
            binding.humCharts.aa_onlyRefreshTheChartDataWithChartOptionsSeriesArray(
                arrayOf(
        ...
        binding.humCharts.aa_drawChartWithChartModel(aaChartModel)
