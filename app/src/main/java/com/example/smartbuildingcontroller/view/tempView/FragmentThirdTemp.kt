...
import com.example.smartbuildingcontroller.databinding.FragmentSecTempBinding
...
class FragmentSecTemp : Fragment() {
    private val model: ConnectToServerViewModel by activityViewModels()
    lateinit var binding:FragmentSecTempBinding
    ...
    override fun onCreateView(
        ...
        binding= FragmentSecTempBinding.inflate(inflater,container,false)
        ...
        val aaChartModel = AAChartModel()
            ...
            .series(
                arrayOf(
                    AASeriesElement()
                        .name("温度")
                        .data(model.notifyHandler.listCan.tempListCan.secTemp.value!!.toArray())
                )
            )
        model.notifyHandler.listCan.tempListCan.secTemp.observe(requireActivity(), Observer {
